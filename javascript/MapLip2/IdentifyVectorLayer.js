			...
			identifyTask.execute(identifyParams, function (idResults)
			{
				...
				for(var i=0;i<idResults.length;i++)
				{
					...
					if(infoTitle == "อาคาร")
					{
						...
						data = data+"<tr><td valign='top'>รูปภาพ</td><td><a href='javascript:void(0);' onclick ="+url+"><img src='Building/"+feature.attributes[outFields[0]]+".JPG' width='60%' height='60%'/></a></td></tr>";
					}
					if(infoTitle == "เอกสารสิทธิ์")
					{
						...
						data = data+"<tr><td valign='top'>เอกสารสิทธิ์</td><td><a href='javascript:void(0);' onclick ="+url+">เปิดดูเอกสารสิทธิ์</a></td></tr>";
					}
					data = data+"</table><hr>";
				}
