...
<body>
	<div id="containner">
		...
		<div id="verticalLineRight">	
			...
			<a href='#' id="btnManual"><img src="images/Manual.png" ></a><br>	
		</div>
		<!-------------Map Section-------------------->
		<div id="map" style="position:relative;width:100%; height:100%;border:0px solid #000;">
			<div class="toggler">
				<!-------------Left Side Menu-------------------->					
					<div id="divData2Container" class="divCOP" style="width:50%;height:90%;top:20px;left:18px;">
										...
										<div id="MySearchHeaderDiv" class="divBG2">
											<table align="center" width="90%">
												...
												<tr>
													...
													<td type="text" style="text-align:center">ลองจิจูด</td>
...
<script>
  ...
  $(function() 
  {
	...
	$("#add").click(function(){
		i++;
		$('#lat_field').append('<tr class="row'+i+'"><td><input type="text" name="lon[]" placeholder="ละติจูด" class="form-control lat_list"></td><td></td></tr>' )
		$('#lon_field').append('<tr class="row'+i+'"><td><input type="text" name="lat[]" placeholder="ลองจิจูด" class="form-control lon_list"></td></tr>' )
